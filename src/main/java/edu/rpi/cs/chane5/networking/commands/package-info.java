/**
 * Package contains the {@link edu.rpi.cs.chane5.networking.commands.Command} for building commands to be used in the protocol
 * between the {@link edu.rpi.cs.chane5.networking.connection.Server} and {@link edu.rpi.cs.chane5.networking.connection.Client}.
 * All commands need to be registered with the {@link edu.rpi.cs.chane5.networking.commands.Registry} using
