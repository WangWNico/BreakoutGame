...
/**
 * Command class base used to create commands for the network protocol between {@link edu.rpi.cs.chane5.networking.connection.Client}
 ...
 * All commands need to be registered with {@link Registry#register(Command)} in order for the protocol in {@link Connection#receive()}
