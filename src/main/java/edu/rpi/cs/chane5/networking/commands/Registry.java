...
/**
 * Registry containing all registered commands in the program. The commands need to be registered in order of {@link Connection#receive()}
 * to process the data into commands.<br>
